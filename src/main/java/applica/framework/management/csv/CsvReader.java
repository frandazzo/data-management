...
public class CsvReader {
    ...
    public CsvReader(String file, String separator, String textSeparator){
        this.csvFile = file;
        this.separator = separator;
    ...
    public CsvReader(String file, String separator, String textSeparator, RowValidator validator){
        this.csvFile = file;
        this.separator = separator;
    ...
    public CsvInfo readFile() {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String[] headers = splitString(line);
                ...
                if (rowNumber == 0){ //si tratta dell'intestazione
                    ...
                    if (!StringUtils.isEmpty(trimmedLine)){
                        String[] rowdata =  splitString(line); //line.split(separator);
    ...
    private String[] splitString(String line) {
        ...
        {
            String regexString = separator+ String.format("(?=([^\\%s]*\\%s[^\\%s]*\\%s)*[^\\%s]*$)", this.textSeparator, this.textSeparator, this.textSeparator, this.textSeparator, this.textSeparator);
            return line.split(regexString, -1);
        }
    }
