 ...
 * @site http://www.sambhashanam.com/mail-merge-in-java-for-microsoft-word-document-and-convert-to-pdf-without-itext-part-ii/
 * @documentation http://code.google.com/p/xdocreport/
 */
 class DocxDocumentMergerAndPdfConverter {
    /**
     ...
     */
    public byte[] generatePDFOutputFromDocx(byte[] docxBytes) throws XDocReportException, IOException, Docx4JException, Docx4JException {
        ...
        System.out.println("logging start" + org.docx4j.convert.out.pdf.viaXSLFO.Conversion.isLoggingEnabled());
